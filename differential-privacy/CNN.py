...
def target_model(input_shape, num_kernels=16, kernel_size=9, batch_size=16, microbatches_perc=1.0, learning_rate=0.01,
                 kernel_regularization=0, drop_prec=0.5, l2_norm_clip=1.0, noise_multiplier=1.0):
    """
...
if __name__ == '__main__':
    ...
    # save results
    filename = "CNN_grid_result_dp.pkl"
